...
export const sunFragmentShader = `
  ...
  void main() {
    vec3 colorCore = vec3(1.0, 0.9, 0.3);
    vec3 colorMid = vec3(1.0, 0.5, 0.0);
    vec3 colorOuter = vec3(0.8, 0.1, 0.0);
    float t = vNoise * 0.5 + 0.5;
    vec3 color = mix(colorOuter, mix(colorMid, colorCore, t), t);
